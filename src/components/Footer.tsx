        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-4">
            ...
            <p className="text-primary-foreground/70 text-sm leading-relaxed">
              Connecting Kenyan expatriates in Toronto through shared culture, 
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                ...
                { href: "/culture", label: "Cultural Activities" },
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li className="flex items-center gap-3 text-sm text-primary-foreground/70">
                ...
                <a href="mailto:hello@nyumbanito.ca" className="hover:text-primary-foreground transition-colors">
                  hello@nyumbanito.ca
                </a>
              </li>
              <li className="flex items-center gap-3 text-sm text-primary-foreground/70">
        ...
        <div className="mt-12 pt-8 border-t border-primary-foreground/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-primary-foreground/50">
              © {new Date().getFullYear()} Nyumbani Toronto. All rights reserved.
            </p>
            <p className="text-sm text-primary-foreground/50">
